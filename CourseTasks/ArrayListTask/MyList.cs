...
namespace ArrayListTask
{
    class МyList<T> : IList<T>
    {
        ...
        private Item<T>[] Contents = new Item<T>[Сapacity];
        ...
        public void EnsureCapacity(int capacity)
        {
            ...
            {
                Item<T>[] ContentsTmp = new Item<T>[capacity];
        ...
        {
            Item<T>[] ContentsTmp = new Item<T>[Count];
        ...
        {
            Item<T> listItem = new Item<T>(data);
            ...
            {
                Item<T>[] ContentsTmp = new Item<T>[Сapacity * 2];
                Array.Copy(Contents, 0, ContentsTmp, 0, Contents.Length);
                Contents = ContentsTmp;
                Contents[Count] = listItem;
                Count++;
